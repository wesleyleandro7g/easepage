import { Type, Palette, Hexagon, MoveRight } from 'lucide-react'
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <main className='pt-20 pb-16 text-center lg:text-left'>
          <div className='flex flex-col gap-3 max-w-4xl text-left'>
            <h1 className='text-5xl sm:text-6xl font-bold leading-[3rem] tracking-tight text-black'>
            ...
            <div className='mt-10 flex flex-col sm:flex-row items-start gap-3'>
              <Link href='/editor' className='w-full'>
                <button className='flex items-center justify-center gap-2 text-lg px-8 py-3 rounded-full w-full bg-black text-white shadow-xl hover:bg-black/90 animate-in'>
